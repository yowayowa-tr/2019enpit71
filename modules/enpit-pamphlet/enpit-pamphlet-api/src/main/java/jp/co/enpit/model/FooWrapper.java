...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(jp.co.enpit.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<jp.co.enpit.model.Foo>
		toCacheModel() {
	...
	@Override
	public jp.co.enpit.model.Foo toEscapedModel() {
	...
	@Override
	public jp.co.enpit.model.Foo toUnescapedModel() {
