 ...
 * <code>jp.co.enpit.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>jp.co.enpit.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static jp.co.enpit.model.Foo addFoo(jp.co.enpit.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static jp.co.enpit.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static jp.co.enpit.model.Foo deleteFoo(jp.co.enpit.model.Foo foo) {
	 ...
	 */
	public static jp.co.enpit.model.Foo deleteFoo(long fooId)
	...
	public static jp.co.enpit.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static jp.co.enpit.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static jp.co.enpit.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static jp.co.enpit.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<jp.co.enpit.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<jp.co.enpit.model.Foo>
	...
	public static java.util.List<jp.co.enpit.model.Foo>
		getFoosByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<jp.co.enpit.model.Foo> orderByComparator) {
	 ...
	 */
	public static jp.co.enpit.model.Foo updateFoo(jp.co.enpit.model.Foo foo) {
